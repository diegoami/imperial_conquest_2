...
At offset `0x15e00` (89,600), the save has the same sequence of **334 city names in 34-byte records** as the DAT. The city-record region differs by just 13 bytes, all in the field at record offset `+24` for 12 cities, including Genua, Mediolanum, Alexandria, and Iconium. That field is mutable, but one save is insufficient to label it as money, population, defense, or anything else. The city-coordinate candidate fields and city names are unchanged.
