...
1. Identify the remaining terrain and special-cell meanings, especially water value `1` and the underlying army/fleet records, using the registered screenshots and original help files.
