...
- **Owns**: `src/IC2.Engine/Naval/Commands/**` (the two new commands and their helpers only), `tests/IC2.Engine.Tests/Naval/**` (new tests only), `src/IC2.Engine/Model/Ruleset.cs` (the `NavalRules` record only, additive)
