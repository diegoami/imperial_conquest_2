...
This document says **when a version number changes, what it is called, who creates it, and what has to be true before it exists**. It sits alongside [game-design.md](game-design.md) (*what* is being built — 20 design milestones), [task-catalogue.md](task-catalogue.md) (the 42 tasks that build it, in 4 phases, with a critical path) and [build-process.md](build-process.md) (*how* — an implementer/reviewer/orchestrator pipeline over GitHub issues).
...
| Label | Applied to |
| --- | --- |
| `release:v0.1.0` | #1–#12, #37 (T30), #45 (T31), #60–#62 (T32–T34), #84 (T40), #89 (T41), #92 (T42) |
