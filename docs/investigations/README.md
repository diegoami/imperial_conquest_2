...
| [auto-resolve-approaches.md](auto-resolve-approaches.md) | Which auto-resolve models could make army composition matter, and how would they be judged? | Specified, not decided: five candidates (C1 the merged instant resolver as baseline, C2 the original's tactical model run headless, C3 type-weighted instant, C4 round-based, C5 morale-and-retreat), a constants register, nine metrics with pass bands fixed in advance, and four observed tactical battles as smoke tests only. Deliberately unranked. | [T59](https://github.com/diegoami/imperial_conquest_2/issues/250), which implements and measures them |
