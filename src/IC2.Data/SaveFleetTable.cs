...
/// <summary>
/// A 26-byte fleet record. Only <see cref="ShipCount"/> and <see cref="CityIndex"/> have controlled-action
/// evidence so far (see docs/reports/fleet-order-at-caere.md): a 10-ship order placed at Caere (city 82)
/// with no turn advance added exactly one such record with ShipCount 10 and CityIndex 82, and no other
/// field in the save changed except the ordering nation's treasury. All other fields are unlabelled.
/// </summary>
