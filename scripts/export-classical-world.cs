...
// ============================================================================================
// 7c. The neighbour mask (T85, correction for #385; T86 moved it onto NationRecord.NeighbourMask
//     itself -- see that field's own remarks) -- straight through IC2.Data's own DAT parse, never
//     derived or typed by hand. One entry per nation, in DAT nation-table order (nationIds' own
//     order); each entry's own neighbour list is bit order (ascending nation code), matching
//     World.StartingNeighbours' own doc comment.
// ============================================================================================
var startingNeighbours = ValueList.Of(nationTable.Nations
    .Select(n =>
    {
        var mask = n.NeighbourMask;
