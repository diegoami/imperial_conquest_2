...
- **As of** `e804f4f`: Phase 0 (foundation) merged, Phase 1 (pure rules) under way — **11 of 38 build tasks merged**: T01–T07, T09, T30, T31, T32. Per-task status is in the [task index](docs/task-catalogue.md#3-task-index).
...
- [Task catalogue](docs/task-catalogue.md) — the 38 build tasks, their dependency graph and status.
