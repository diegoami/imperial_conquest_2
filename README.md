...
- **As of** `acd4098`: Phase 0 (foundation) merged, Phase 1 (pure rules) under way — **9 of 35 build tasks merged**: T01–T07, T30, T31. Per-task status is in the [task index](docs/task-catalogue.md#3-task-index).
...
- [Task catalogue](docs/task-catalogue.md) — the 35 build tasks, their dependency graph and status.
