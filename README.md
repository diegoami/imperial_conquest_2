...
- **Next**: T08 (economy, supply and purses) is **escalated** — PR #53 failed review at round 2 on a supply-capacity source disagreement and is waiting on the planner and the user ([operating-guide.md §1](docs/operating-guide.md#1-current-state)). A fresh orchestrator mandate is under way for the rest of T08's scope and has dispatched T09 (movement and terrain), now **in progress**. T29 is still blocked (waiting on T30, T34, T15, T17, T19); the ready set is T10, T11, T12, T33, T34.
